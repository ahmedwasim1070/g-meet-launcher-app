...
function PaymentPop() {
    ...
    return (
        <section className="min-w-screen min-h-screen bg-gray-900/40 backdrop-blur-sm fixed z-50 inset-0 flex items-center justify-center p-4">
            {/*  */}
